...
Built using Javascript and Knockout.js. this application obtain information using the Google Maps API and the Wikipedia API. As a result, the user can get locations, snippets, images of the targetted places.
